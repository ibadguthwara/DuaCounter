...
public class DoaSholatMayit extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_doa_sholat_mayit);
        ...
        tombol.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final Dialog dialog = new Dialog(DoaSholatMayit.this);
                dialog.setContentView(R.layout.info_doa_sholat_mayit);
